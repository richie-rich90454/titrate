...
- **Garbage collection** (C#, Python, Go) automatically reclaims memory, but at a cost: unpredictable pauses, runtime overhead, and less control over when things are cleaned up.
