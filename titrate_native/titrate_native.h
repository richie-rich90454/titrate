...
TitrateValue titrate_Os_killSignal(const TitrateValue *args, size_t arg_count);
...
TitrateValue titrate_Subprocess_runFull(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Subprocess_runWithInput(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Subprocess_runWithTimeout(const TitrateValue *args, size_t arg_count);
...
TitrateValue titrate_ArrayList_add(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_ArrayList_clear(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_ArrayList_contains(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_ArrayList_get(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_ArrayList_indexOf(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_ArrayList_isEmpty(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_ArrayList_new(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_ArrayList_remove(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_ArrayList_removeAt(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_ArrayList_set(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_ArrayList_size(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_ArrayList_toString(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Boolean_toString(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_CryptoExt_chacha20Poly1305Decrypt(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_CryptoExt_chacha20Poly1305Encrypt(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_CryptoExt_curve25519KeyExchange(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_CryptoExt_ed25519Sign(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_CryptoExt_ed25519Verify(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_CryptoExt_hkdfExpand(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_CryptoExt_hkdfExtract(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Ctypes_call(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Ctypes_dlclose(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Ctypes_dlopen(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Ctypes_dlsym(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Ctypes_load(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Ctypes_symclose(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Double_toString(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Fcntl_fcntl(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Fcntl_flock(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Fcntl_ioctl(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Fcntl_lockf(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_File_append(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_File_exists(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_File_readChunk(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_File_rename(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_File_tryLock(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_File_unlock(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Float_fromF32Bits(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Float_toF32Bits(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Float_toString(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Fs_closeWatch(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Fs_pollWatchEvents(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_HashMap_clear(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_HashMap_containsKey(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_HashMap_containsValue(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_HashMap_get(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_HashMap_hasKey(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_HashMap_isEmpty(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_HashMap_keys(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_HashMap_new(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_HashMap_put(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_HashMap_remove(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_HashMap_size(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_HashMap_toString(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_HashMap_values(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Integer_parseInt(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Integer_toString(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_JsonValue_asArray(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_JsonValue_asBool(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_JsonValue_asNumber(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_JsonValue_asObject(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_JsonValue_asString(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_JsonValue_hasKey(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_JsonValue_isArray(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_JsonValue_isBool(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_JsonValue_isNull(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_JsonValue_isNumber(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_JsonValue_isObject(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_JsonValue_isString(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_JsonValue_keys(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_JsonValue_size(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Long_toString(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lz4_compress(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lz4_compressBound(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lz4_compressWithAcceleration(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lz4_decompress(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lz4_decompressSafe(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lz4_frameBlockMode(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lz4_frameBlockSize(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lz4_frameCompress(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lz4_frameContentChecksumFlag(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lz4_frameContentSize(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lz4_frameDecompress(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lz4_frameDictId(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lz4_highCompressionCompress(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lz4_highSpeedCompress(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lz4_versionNumber(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lz4_xxhash32(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lz4_xxhash64(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lzma_compress(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Lzma_decompress(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Math_fabs(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_MathAdvanced_cbrt(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_MathAdvanced_exp(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_MathAdvanced_ln(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_MathAdvanced_log10(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_MathAdvanced_log2(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_MathAdvanced_pow(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_MathAdvanced_sqrt(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_native_call_out(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Process_join(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Process_spawn(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Process_terminate(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Pty_fork(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Pty_openpty(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Pty_spawn(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Queue_close(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Queue_new(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Queue_recv(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Queue_send(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Regex_findAllNamedCaptures(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Regex_findNamedCapture(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Regex_split(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Resource_getrlimit(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Resource_getrusage(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Resource_setrlimit(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_String_contains(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_String_indexOf(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_String_join(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_String_substring(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Syslog_closelog(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Syslog_openlog(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Syslog_setlogmask(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Syslog_syslog(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_System_currentTimeMillis(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Termios_tcdrain(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Termios_tcflush(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Termios_tcgetattr(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Termios_tcsendbreak(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Termios_tcsetattr(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_WinReg_CloseKey(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_WinReg_CreateKey(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_WinReg_DeleteKey(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_WinReg_DeleteValue(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_WinReg_EnumKey(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_WinReg_EnumValue(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_WinReg_OpenKey(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_WinReg_QueryValue(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_WinReg_SetValue(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_WinSound_Beep(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_WinSound_MessageBeep(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_WinSound_PlaySound(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_ZipFile_entries(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_compress(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_compressBound(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_compressWithDict(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_compressWithParams(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_countFrames(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_decompress(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_decompressFrame(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_decompressWithDict(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_frameBlockSizeMax(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_frameChecksumFlag(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_frameHeaderSize(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_frameWindowSize(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_getDictId(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_getFrameContentSize(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_isFrame(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_maxCompressionLevel(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_minCompressionLevel(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_trainDictionary(const TitrateValue *args, size_t arg_count);
TitrateValue titrate_Zstd_versionNumber(const TitrateValue *args, size_t arg_count);
