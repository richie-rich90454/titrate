...
pub fn lookup_builtin_native(name: &str) -> Option<NativeFn> {
    match name {
        ...
        "JsonValue_ofObject" => Some(json::native_jsonvalue_of_object),
        "JsonValue_ofArray" => Some(json::native_jsonvalue_of_array),
        "JsonValue_ofStr" => Some(json::native_jsonvalue_of_str),
        ...
        "Fs_closeWatch" => Some(system::native_fs_close_watch),
        "Fs_pollWatchEvents" => Some(system::native_fs_poll_watch_events),
        ...
        "System_currentTimeMillis" => Some(system::native_system_current_time_millis),
