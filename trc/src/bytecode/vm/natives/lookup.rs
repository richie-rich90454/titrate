...
use super::{builtins, file, path, directory, system, system_containers, system_os, net, time, regex, math,
...
pub fn lookup_builtin_native(name: &str) -> Option<NativeFn> {
    match name {
        ...
        "Math_fabs" => Some(math::native_math_abs),
        ...
        // JsonValue instance methods (for LLVM backend native bridge)
        "JsonValue_isNull" => Some(json::native_jsonvalue_is_null),
        "JsonValue_isBool" => Some(json::native_jsonvalue_is_bool),
        "JsonValue_isNumber" => Some(json::native_jsonvalue_is_number),
        "JsonValue_isString" => Some(json::native_jsonvalue_is_string),
        "JsonValue_isArray" => Some(json::native_jsonvalue_is_array),
        "JsonValue_isObject" => Some(json::native_jsonvalue_is_object),
        "JsonValue_asBool" => Some(json::native_jsonvalue_as_bool),
        "JsonValue_asNumber" => Some(json::native_jsonvalue_as_number),
        "JsonValue_asString" => Some(json::native_jsonvalue_as_string),
        "JsonValue_asArray" => Some(json::native_jsonvalue_as_array),
        "JsonValue_asObject" => Some(json::native_jsonvalue_as_object),
        "JsonValue_size" => Some(json::native_jsonvalue_size),
        "JsonValue_hasKey" => Some(json::native_jsonvalue_has_key),
        "JsonValue_keys" => Some(json::native_jsonvalue_keys),
        ...
        "Fs_totalSpace" => Some(system_os::native_fs_total_space),
        "Fs_freeSpace" => Some(system_os::native_fs_free_space),
        "Fs_closeWatch" => Some(system_os::native_fs_close_watch),
        "Fs_pollWatchEvents" => Some(system_os::native_fs_poll_watch_events),
        ...
        "String_contains" => Some(string::native_string_contains),
        "String_join" => Some(string::native_string_join),
        ...
        // MathAdvanced aliases — map to Math natives
        "MathAdvanced_sqrt" => Some(math::native_math_sqrt),
        "MathAdvanced_pow" => Some(math::native_math_pow),
        "MathAdvanced_exp" => Some(math::native_math_exp),
        "MathAdvanced_ln" => Some(math::native_math_ln),
        "MathAdvanced_log2" => Some(math::native_math_log2),
        "MathAdvanced_log10" => Some(math::native_math_log10),
        "MathAdvanced_cbrt" => Some(math::native_math_cbrt),
        "Float_toF32Bits" => Some(math::native_float_to_f32_bits),
        "Float_fromF32Bits" => Some(math::native_float_from_f32_bits),
        "System_currentTimeMillis" => Some(system_os::native_system_current_time_millis),
        ...
        "Regex_findNamedCapture" => Some(regex::native_regex_find_named_capture),
        "Regex_findAllNamedCaptures" => Some(regex::native_regex_find_all_named_captures),
        "Regex_split" => Some(regex::native_regex_split),
        ...
        "ZipFile_entries" => Some(zip::native_zipfile_entries),
        ...
        "Os_cpuCount" => Some(system_os::native_os_cpu_count),
        "Os_userName" => Some(system_os::native_os_user_name),
        "Os_hostName" => Some(system_os::native_os_host_name),
        "Os_urandom" => Some(system_os::native_os_urandom),
        "Os_chmod" => Some(system_os::native_os_chmod),
        "Os_makedirs" => Some(system_os::native_os_makedirs),
        "Os_symlink" => Some(system_os::native_os_symlink),
        "Os_readlink" => Some(system_os::native_os_readlink),
        "Os_kill" => Some(system_os::native_os_kill),
        "Os_killSignal" => Some(system_os::native_os_kill_signal),
        "Os_environ" => Some(system_os::native_os_environ),
        "Os_umask" => Some(system_os::native_os_umask),
        "Os_scandir" => Some(system_os::native_os_scandir),
        "Os_environMap" => Some(system_os::native_os_environ_map),
        "Os_getpid" => Some(system::native_process_id),
        "Os_getcwd" => Some(system::native_sys_working_dir),
        "Os_chdir" => Some(system_os::native_sys_change_dir),
        "Os_getenv" => Some(system::native_env_get),
        "Os_setenv" => Some(system::native_env_set),
        "Os_unsetenv" => Some(system_os::native_env_unset),
        "Os_system" => Some(system_os::native_os_system),
        "Os_uname" => Some(system_os::native_os_uname),
        "Os_getppid" => Some(system_os::native_os_getppid),
        "Os_strerror" => Some(system_os::native_os_strerror),
        "Os_removedirs" => Some(system_os::native_os_removedirs),
        "Os_renames" => Some(system_os::native_os_renames),
        "Os_replace" => Some(system_os::native_os_replace),
        "Os_link" => Some(system_os::native_os_link),
        "Os_utime" => Some(system_os::native_os_utime),
        "Os_lstat" => Some(system_os::native_os_lstat),
        "Os_access" => Some(system_os::native_os_access),
        "Os_release" => Some(system_os::native_os_release),
        "Os_version" => Some(system_os::native_os_version),
        "Titrate_version" => Some(system_os::native_titrate_version),
        "Gc_collect" => Some(system_os::native_gc_collect),
        ...
        "ArrayList_size" => Some(system_containers::native_arraylist_size),
        "ArrayList_get" => Some(system_containers::native_arraylist_get),
        "ArrayList_add" => Some(system_containers::native_arraylist_add),
        "ArrayList_new" => Some(system_containers::native_arraylist_new),
        "ArrayList_set" => Some(system_containers::native_arraylist_set),
        "ArrayList_remove" => Some(system_containers::native_arraylist_remove),
        "ArrayList_removeAt" => Some(system_containers::native_arraylist_remove_at),
        "ArrayList_contains" => Some(system_containers::native_arraylist_contains),
        "ArrayList_indexOf" => Some(system_containers::native_arraylist_index_of),
        "ArrayList_isEmpty" => Some(system_containers::native_arraylist_is_empty),
        "ArrayList_clear" => Some(system_containers::native_arraylist_clear),
        "ArrayList_toString" => Some(system_containers::native_arraylist_to_string),

        // HashMap native methods (for LLVM backend)
        "HashMap_new" => Some(system_containers::native_hashmap_new),
        "HashMap_size" => Some(system_containers::native_hashmap_size),
        "HashMap_get" => Some(system_containers::native_hashmap_get),
        "HashMap_put" => Some(system_containers::native_hashmap_put),
        "HashMap_containsKey" => Some(system_containers::native_hashmap_contains_key),
        "HashMap_hasKey" => Some(system_containers::native_hashmap_contains_key),
        "HashMap_containsValue" => Some(system_containers::native_hashmap_contains_value),
        "HashMap_remove" => Some(system_containers::native_hashmap_remove),
        "HashMap_keys" => Some(system_containers::native_hashmap_keys),
        "HashMap_values" => Some(system_containers::native_hashmap_values),
        "HashMap_isEmpty" => Some(system_containers::native_hashmap_is_empty),
        "HashMap_clear" => Some(system_containers::native_hashmap_clear),
        "HashMap_toString" => Some(system_containers::native_hashmap_to_string),
