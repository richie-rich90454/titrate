// Control flow, objects, and system opcodes

use super::super::frame::{ExceptionHandler, Frame};
use super::super::opcodes::{CastTarget, OpCode, TypeTag};
...
impl Vm {
    pub(super) fn step_flow(&mut self, op: OpCode) -> Result<(), String> {
        match op {
            OpCode::JMP => {
            ...
            _ => return Err(format!("step_flow: unexpected opcode {:?}", op)),         }          Ok(())     } }
